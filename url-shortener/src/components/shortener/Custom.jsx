...
//     try {
//       // Add logic to fetch the shortened URL from the API
...
//         try {
//             const response = await axios.get('http://localhost:4000/api/links/:id');
//             const data = response.data;
//             setShortenedUrl(data.shortUrl); // Update the state with the shortened URL
//         } catch (error) {
//             console.error('Error fetching shortened URL:', error);
//         }
//     };
    ...
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex space-x-2">
          <button className="bg-zinc-800 text-white px-4 py-2 rounded-md text-sm">
            Copy
          </button>
